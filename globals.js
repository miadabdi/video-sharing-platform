...
exports.videoFolder = Path.join(__dirname, "./storage/videos");
exports.captionFolder = Path.join(__dirname, "./storage/captions");
exports.thumbnailFolder = Path.join(__dirname, "./storage/thumbnails");
...
exports.RFC5646_LANGUAGE_TAGS = RFC5646_LANGUAGE_TAGS;
