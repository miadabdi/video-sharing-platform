...
ChannelSchema.pre("save", function preSaveSubscribers(next) {
...
ChannelSchema.method("pushSubscriber", function pushSubscriber(userId) {
...
ChannelSchema.method("removeSubscriber", function removeSubscriber(userId) {
